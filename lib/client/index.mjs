...
function ComposerBar(props) {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			props.footer,
			view.error !== void 0 && /* @__PURE__ */ jsx("p", {
				role: "alert",
				children: view.error.message
			}),
			/* @__PURE__ */ jsx(ConversationHandoff, {
...
function ConversationDirectorySection(props) {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("label", { children: ["对话根目录", /* @__PURE__ */ jsx("input", {
				value: rootDirectory,
				onChange: (event) => {
					setRootDirectory(event.currentTarget.value);
				}
			})] }),
			/* @__PURE__ */ jsxs("label", { children: ["目录名模板", /* @__PURE__ */ jsx("input", {
				value: template,
				onChange: (event) => {
			...
			preview !== void 0 && /* @__PURE__ */ jsx("output", { children: preview }),
...
function SidebarBrowser(props) {
	...
	const [searchIds, setSearchIds] = useState(void 0);
	const [searching, setSearching] = useState(false);
	const [dragged, setDragged] = useState(void 0);
	const [editing, setEditing] = useState(void 0);
	const [rowError, setRowError] = useState(void 0);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			!props.wide && /* @__PURE__ */ jsx("button", {
				type: "button",
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsxs("header", { children: [
					/* @__PURE__ */ jsx("span", { children: "工作区" }),
					/* @__PURE__ */ jsx("button", {
						type: "button",
						onClick: () => {
					...
					directoryFlowAvailable && /* @__PURE__ */ jsx("button", {
						type: "button",
				...
				] }), workspaces.map((workspace) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("button", {
					type: "button",
					onClick: () => {
						props.startWorkspaceSession(workspace.workspaceId);
					},
					children: workspace.title ?? workspace.path
				}), /* @__PURE__ */ jsx("span", { children: workspace.sessionIds.length })] }, workspace.workspaceId))]
			}),
			props.renderSlot("sidebar.workspaces.directoryFlow", directoryFlow),
			/* @__PURE__ */ jsxs("section", {
				"aria-label": "对话",
				children: [
					/* @__PURE__ */ jsxs("header", { children: [/* @__PURE__ */ jsx("span", { children: "对话" }), /* @__PURE__ */ jsx("input", {
						value: query,
						placeholder: "搜索对话",
						onChange: (event) => {
						...
						return /* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("button", {
									...
									children: [
										/* @__PURE__ */ jsx("span", { children: row.displayTitle }),
										status !== void 0 && /* @__PURE__ */ jsx("span", {
											"aria-label": status,
											children: status
										}),
										/* @__PURE__ */ jsx("time", {
								...
								editingRow !== void 0 && /* @__PURE__ */ jsxs("form", {
									onSubmit: (event) => {
										event.preventDefault();
										rename();
									},
					...
					searching && /* @__PURE__ */ jsx("p", {
						role: "status",
						children: "正在搜索"
					}),
					rowError !== void 0 && /* @__PURE__ */ jsx("p", {
						role: "alert",
						children: rowError
					}),
					visibleAutomatic.length === 0 && /* @__PURE__ */ jsx("p", { children: "暂无对话" })
				]
			})
		]
	});
...
function WorkspacePicker(props) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			props.open && /* @__PURE__ */ jsxs("div", {
				role: "menu",
				children: [
					workspaces.map((workspace) => /* @__PURE__ */ jsx("button", {
						type: "button",
						role: "menuitem",
						disabled: picking,
						onClick: () => {
					...
					flowAvailable && /* @__PURE__ */ jsx("button", {
						type: "button",
						role: "menuitem",
						disabled: picking,
						onClick: () => {
