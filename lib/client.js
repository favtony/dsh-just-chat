	...
	factory: (require) => {
		...
		*/
		...
		function createComposerBarAdapter(deps) {
			return (official) => function ComposerBarAdapter(props) {
				const pending = (0, react.useSyncExternalStore)((listener) => deps.pending.subscribe(listener), () => deps.pending.getSnapshot(), () => deps.pending.getSnapshot());
				const view = (0, react.useSyncExternalStore)((listener) => deps.view.subscribe(listener), () => deps.view.getSnapshot(), () => deps.view.getSnapshot());
				...
				const state = (0, react.useMemo)(() => pendingInput(pending.draft, busy, revision.current.value), [
					busy,
					pending.draft,
				...
				const inputActions = (0, react.useMemo)(() => ({
				...
				const keyboard = (0, react.useMemo)(() => ({
					get snapshot() {
						return state;
					},
					setDraft: (draft) => deps.updatePendingDraft(draft),
				...
				return (0, react.createElement)(react.Fragment, null, (0, react.createElement)(official, justChat ? {
					...props,
					disabled: false,
					useInput,
					inputActions,
					keyboard
				} : props), props.sessionId === void 0 || props.inputActions === void 0 ? null : (0, react.createElement)(ConversationHandoff, {
		...
		function createConversationAdapter(deps) {
			return (official) => function ConversationAdapter(props) {
				...
				const projected = (0, react.useMemo)(() => projectConversationState(hostState, pending, sessionId), [
					hostState,
					pending,
					sessionId
				]);
				...
				const selectWorkspace = (0, react.useCallback)(async (workspaceId) => {
		...
		*/
		function CombinedSidebarContent({ deps, official, props, rootRef }) {
			const view = (0, react.useSyncExternalStore)((listener) => deps.view.subscribe(listener), () => deps.view.getSnapshot(), () => deps.view.getSnapshot());
			const conversationOrder = (0, react.useSyncExternalStore)((listener) => deps.order.subscribe(listener), () => deps.order.getSnapshot(), () => deps.order.getSnapshot());
			...
			const automaticIds = (0, react.useMemo)(() => automaticSessionIds(view, hostSessions), [hostSessions, view]);
			const automaticIdSet = (0, react.useMemo)(() => new Set(automaticIds), [automaticIds]);
			const projectedWorkspaces = (0, react.useMemo)(() => projectWorkspaceState(hostWorkspaces, view, hostSessions), [
				hostSessions,
				hostWorkspaces,
				view
			]);
			const ordinarySessions = (0, react.useMemo)(() => projectOrdinarySessionState(hostSessions, automaticIds), [automaticIds, hostSessions]);
			const automaticSessions = (0, react.useMemo)(() => projectAutomaticSessionState(hostSessions, automaticIds), [automaticIds, hostSessions]);
			const conversationWorkspaces = (0, react.useMemo)(() => ({
				...hostWorkspaces,
				items: []
			}), [hostWorkspaces]);
			const orderedConversationIds = (0, react.useMemo)(() => {
			...
			const conversationUpdatedAt = (0, react.useMemo)(() => Object.fromEntries(automaticIds.map((id) => [id, hostSessions.byId[id]?.updatedAt ?? 0])), [automaticIds, hostSessions.byId]);
			const workspaceStore = (0, react.useMemo)(() => ({
				...hostStore,
				groupBy: "workspace"
			}), [hostStore]);
			const conversationStore = (0, react.useMemo)(() => ({
				...hostStore,
				groupBy: "flat",
				orderBy: "manual",
			...
			const conversationSearchSessions = (0, react.useCallback)(async (query, signal) => {
				const result = await props.searchSessions(query, signal);
				return {
					...result,
					items: result.items.filter((item) => automaticIdSet.has(item.sessionId))
			...
			const workspaceActions = (0, react.useMemo)(() => ({
				...props.actions,
				setGroupBy: () => {},
			...
			const conversationActions = (0, react.useMemo)(() => ({
				...props.actions,
				setGroupBy: () => {},
				setOrderBy: () => {},
				setGroupExpanded: () => {},
			...
			const rejectConversationWorkspaceAction = (0, react.useCallback)(() => {
				return Promise.reject(/* @__PURE__ */ new Error("对话分区不支持工作区操作"));
			}, []);
			const rejectConversationSessionOrder = (0, react.useCallback)(() => {
				return Promise.reject(/* @__PURE__ */ new Error("对话分区不支持工作区会话排序"));
			}, []);
			const conversationT = (0, react.useCallback)((key, params) => {
			...
			}, (0, react.createElement)(official, workspaceProps)), props.wide ? (0, react.createElement)("div", {
				"data-dsh-just-chat-section": "conversations",
				style: SIDEBAR_SECTION_STYLE
			}, (0, react.createElement)(official, conversationProps)) : null);
		}
		/**
		...
		*/
		function createSidebarBrowserAdapter(deps) {
			return (official) => function SidebarBrowserAdapter(props) {
				...
				const disablePlugin = (0, react.useCallback)(() => {
					setDisabled(true);
				}, []);
				const officialComponent = official;
				const fallback = (0, react.createElement)(officialComponent, props);
				if (disabled) return fallback;
				const pluginLayout = (0, react.createElement)(CombinedSidebarContent, {
					deps,
					official: officialComponent,
					props,
					rootRef
				});
				return (0, react.createElement)(SidebarErrorBoundary, {
					fallback,
					onError: disablePlugin
				}, (0, react.createElement)(SidebarLayoutGuard, {
					wide: props.wide,
					rootRef,
		...
		function createWorkspacePickerAdapter(deps) {
			return (official) => function WorkspacePickerAdapter(props) {
				const hostState = props.useWorkspaces((state) => state);
				const pending = (0, react.useSyncExternalStore)((listener) => deps.pending.subscribe(listener), () => deps.pending.getSnapshot(), () => deps.pending.getSnapshot());
				const projected = (0, react.useMemo)(() => projectPickerState(hostState), [hostState]);
				const useWorkspaces = (selector) => {
					props.useWorkspaces((state) => state);
					return selector(projected);
				};
		...
		[...Array.from({ length: 9 }, (_, index) => "COM" + String(index + 1)), ...Array.from({ length: 9 }, (_, index) => "LPT" + String(index + 1))];
		//#endregion
		...
		function ConversationDirectorySection(props) {
			...
			const [rootDirectory, setRootDirectory] = (0, react.useState)(initial.rootDirectory);
			const [template, setTemplate] = (0, react.useState)(initial.template);
			const [saved, setSaved] = (0, react.useState)(initial);
			const [preview, setPreview] = (0, react.useState)(void 0);
			const [error, setError] = (0, react.useState)(void 0);
			const [pickingDirectory, setPickingDirectory] = (0, react.useState)(false);
			const [saving, setSaving] = (0, react.useState)(false);
			const [open, setOpen] = (0, react.useState)(false);
			const savedRequest = (0, react.useRef)(null);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { className: `${styles.chevron} ${open ? styles.chevronOpen : ""}` })
					]
					...
					children: [
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Input, {
										...
										variant: "outline",
										size: "sm",
										icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconBrowseOutline16, { size: 16 }),
										disabled: controlsDisabled || pickingDirectory,
										onClick: () => {
											browse();
										},
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
										...
										children: ["默认模板：", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: "${date.yyyy}-${date.MM}-${date.dd}/${time.HH}-${time.mm}-${time.ss}-${message.firstSentence}" })]
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dl", {
										className: styles.variables,
										children: TEMPLATE_VARIABLES.map((variable) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											className: styles.variable,
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", {
												className: styles.variableName,
												children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: variable.expression })
						...
						preview !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("output", {
